...
#ifndef VISO2_EVALUATION_TASK_TASK_HPP
#define VISO2_EVALUATION_TASK_TASK_HPP

#include "viso2_evaluation/TaskBase.hpp"

namespace viso2_evaluation{
...
tasks/Task.cpp, and will be put in the viso2_evaluation namespace.
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','viso2_evaluation::Task')
     end
     \endverbatim
    ...
    protected:
        ...
        base::samples::RigidBodyState gt_pose, gt_initial_pose, odo_pose;
